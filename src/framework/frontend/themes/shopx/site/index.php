            ...
            <div class="container">
                <div class="row">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img src="/shopx/assets/images/flogo.png" alt="" class="img-responsive"></a>
                    </div>
                        ...
                        <ul>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu xt-cart-items">
                                    <li>
                                        <a href="">
                                            <img src="/shopx/assets/images/4.jpg" alt="">
                                            <h3>Lipstick</h3>
                                    ...
                                    <li>
                                        <a href="">
                                            <img src="/shopx/assets/images/1.jpg" alt="">
                                            <h3>T-Shirt</h3>
                                    ...
                                    <li>
                                        <a href="">
                                            <img src="/shopx/assets/images/3.jpg" alt="">
                                            <h3>Shirt</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-md-offset-3 padding-o padding-sm">
                <div class="flexslider xt-slider-inner">
                    <ul class="slides">
                        <li>
                            <img src="/shopx/assets/images/model-five.jpg" alt="" />
                        ...
                        <li>
                            <img src="/shopx/assets/images/model-four.jpg" alt="" />
                            <div class="slide_text">
                        ...
                        <li>
                            <img src="/shopx/assets/images/model-three.jpg" alt="" />
                            <div class="slide_text">
                ...
                <div class="flexslider-controls">
                    <ol class="flex-control-nav">
                        <li>
                            <img src="/shopx/assets/images/model-five-thumb.jpg" alt="" />
                            <div class="nav-title">
                                <span>Fashion</span>
                        ...
                        <li>
                            <img src="/shopx/assets/images/model-four-thumb.jpg" alt="" />
                            <div class="nav-title">
                                <span>Style</span>
                        ...
                        <li>
                            <img src="/shopx/assets/images/model-three-thumb.jpg" alt="" />
                            <div class="nav-title">
                                <span>Spring</span>
        ...
        <div class="row section-separator">
            <div class="xt-each-deal">
                <div class="col-md-8 col-sm-6">
                    <div class="xt-spring-deal cover-bg white xt-deal" style="background-image: url(/shopx/assets/images/f1.jpg);">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="xt-summer-deal cover-bg white xt-deal" style="background-image: url(/shopx/assets/images/f2.jpg);">
                        <div class="xt-overlay"></div>
                ...
                <div class="col-md-8 col-sm-6">
                    <div class="xt-summer-deal cover-bg white xt-deal" style="background-image: url(/shopx/assets/images/f3.jpg);">
                        <div class="xt-overlay"></div>
        ...
        <div class="row section-separator">
            ...
            <div class="xt-each-feature">
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/2.jpg" alt="" class="img-responsive">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/1.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/3.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/4.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/b2.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/b1.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
        ...
        <div class="row section-separator">
            ...
            <div class="xt-category-feature col-xs-12">
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/model-one-660-640.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                                <span class="category xt-uppercase">Winter COllection</span>
                                <span class="name xt-semibold">Black Color</span>
                            </div>
                            <div class="price-tag pull-right">
                                <span class="old-price"><del>$280</del></span>
                                <span class="new-price xt-semibold">$260</span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/model-two-660-640.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                                <span class="category xt-uppercase">Autumn Collection</span>
                                <span class="name xt-semibold">Imported From U.A.E.</span>
                            </div>
                            <div class="price-tag pull-right">
                                <span class="old-price"><del>$280</del></span>
                                <span class="new-price xt-semibold">$260</span>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-feature">
                        <div class="product-img">
                            <img src="/shopx/assets/images/model-five-660-640.jpg" alt="" class="img-responsive">
                            <span class="product-tag xt-uppercase">sale!</span>
                        </div>
                        <div class="product-info">
                            <div class="product-title">
                                <span class="category xt-uppercase">Spring Collection</span>
                                <span class="name xt-semibold">2017 New Model</span>
                            </div>
                            <div class="price-tag pull-right">
                                <span class="old-price"><del>$280</del></span>
                                <span class="new-price xt-semibold">$260</span>
        ...
        <div class="row">
            ...
            <div class="testimonial-content col-xs-12 xt-client-carousel">
                <div class="xt-clients">
                    <div class="user-img">
                        <img src="/shopx/assets/images/t3.jpg" alt="" class="img-responsive">
                    </div>
                    <h5>Richard I. Moore</h5>
                    <span>Manager</span>
                    <p>The founder of SEO Monster is so helpful and efficient with any problem you might have.
                        I highly recommend choosing his products. Professional, sexy, sleek, and fun!
                    </p>
                </div>
                <div class="xt-clients">
                    <div class="user-img">
            ...
            <div class="xt-blog col-xs-12">
                <div class="col-md-4 col-sm-4">
                    <div class="xt-grid-post">
                        <img src="/shopx/assets/images/blog1.jpg" alt="" class="img-responsive">
                        <div class="grid-content">
                            <span>Feb 10, 2015</span>
                            <a href=""><h3>From fashion to style of my life</h3></a>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-grid-post">
                        <img src="/shopx/assets/images/blog2.jpg" alt="" class="img-responsive">
                        <div class="grid-content">
                            <span>Feb 10, 2015</span>
                            <a href=""><h3>Timeless designs</h3></a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit volu
                                ptatem accusantium doloremque.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="xt-grid-post">
                        <img src="/shopx/assets/images/b3.jpg" alt="" class="img-responsive">
                        <div class="grid-content">
                            <span>Feb 10, 2015</span>
                            <a href=""><h3>Celebrating fashion</h3></a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit volu
                                ptatem accusantium doloremque.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    <div class="footer-widget footer-contact">
                        <img src="/shopx/assets/images/flogo.png" alt="" class="img-responsive">
                        <ul>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row section-separator">
                ...
                <div class="col-md-6 col-sm-6">
                    <img src="/shopx/assets/images/payment.png" alt="" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
